...
setup(
    ...
    entry_points={
        'console_scripts': [
            'trayectory_node = elipse_sim.trayectory_node:main',
            'PointStabilisation_node = elipse_sim.point_stabilisation_control:main',
            'localisation = elipse_sim.localisation:main',
